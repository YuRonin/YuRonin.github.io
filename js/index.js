...
//		模块三
		var blessing = [
			'Good luck getting rid of the single dog this year',
			'May your height reach 165cm this year',
			'May you make great progress this year',
			'I hope you can be admitted to a good university',
			'May you have a wonderful year',
			'The family are kind and healthy',
		];
		vartexts = $("<span></span>");
...
//		倒计时
		...
		i4=0;
		function settime(){
			let st1 = new Date("2021.12.25 00:00:00").getTime();
			...
			let st11 = new Date("2021.12.24 23:59:59").getTime();
